    ...
    <div>
      <div className="flex flex-wrap border-2 dark:bg-black bg-red-100">
        <div className="flex-col ml-2 flex-grow">
          <h1 className="font-bold text-4xl mt-10">WEDDING-VENUES</h1>
          <h3 className="flex font-bold text-2xl mt-5">
            There Are Many Plans in WeddingVenues:-
            Wedding-formhouse,Hotels,Banquet-Halls,Marriage-Garden,Kalyana-Mandapam,Wedding-Resorts
          </h3>
        </div>
