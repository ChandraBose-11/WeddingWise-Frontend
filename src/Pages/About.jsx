    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center dark:text-white dark:bg-black">
      <div className="w-4/5 mt-2 bg-white mb-3 mx-auto rounded-lg p-8 dark:text-white dark:bg-neutral-900 dark:shadow-2xl dark:shadow-neutral-400 shadow-2xl ">
        ...
        <p className="text-lg text-gray-700 mb-8 dark:text-gray-300">
          ...
          , a management developed by me using the MERN stack (MongoDB,
          Express.js, React, and Node.js). This is designed to help individuals
        ...
        <div className="mb-8">
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-700 dark:text-neutral-200">
              Wedding management, also known as wedding coordination, is the
              process of helping a couple plan and execute their wedding. A
              wedding manager works with a couple to ensure that all the
              behind-the-scenes details are taken care of so the couple can
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc list-inside ml-4 text-gray-700 dark:text-neutral-200">
              ...
              <li className="mb-1">
                ...
                creating sections. Update section details and delete them as
                required.
              </li>
              <li className="mb-1">
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc list-inside ml-4 text-gray-700 dark:text-neutral-200">
              <li className="mb-1">
                Contains Navbar Pages to download individual reports of projects
                if the task status is closed.
              </li>
              <li className="mb-1">
